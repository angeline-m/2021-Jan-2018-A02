...
<div class="row">
 ...
 <div class="row">
    ...
    <div class="col-sm-9">
        ...
        <asp:HiddenField ID="SearchArg" runat="server" />
    ...
    <asp:ObjectDataSource ID="TracksSelectionListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="List_TracksForPlaylistSelection" OnSelected="SelectCheckForException" TypeName="ChinookSystem.BLL.TrackController">
        <SelectParameters>
            <asp:ControlParameter ControlID="TracksBy" PropertyName="Text" DefaultValue="dfghjlk" Name="tracksby" Type="String"></asp:ControlParameter>
            <asp:ControlParameter ControlID="SearchArg" PropertyName="Value" DefaultValue="dfghjkl" Name="arg" Type="String"></asp:ControlParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
